        ...
        <div className="profile__reviews">
            ...
            <div className="profile__reviews-left">
                <div className="profile__reviews-left-header">
                    <div className="profile__reviews-left-header-title">Évaluations</div>
                    <div className="profile__reviews-left-header-rating">4,6</div>
                </div>
                <div className="profile__reviews-left-subheader">3 commentaires</div>
                <div className="profile__reviews-left-list">
                    <div className="profile__reviews-left-item">
                        ...
                        <div className="profile__reviews-left-item-rating">4,2</div>
                    </div>
                    <div className="profile__reviews-left-item">
                        <div className="profile__reviews-left-item-info">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="profile__reviews-right-item">
                        ...
                        <div className="profile__reviews-right-item-infos">
                            <div className="profile__reviews-right-item-header">
                                <div className="profile__reviews-right-item-header-name">ProGamer123</div>
                                <div className="profile__reviews-right-item-header-ratinginfo">
                                    <span>3,4</span>
                                    <span>il y a 3 jours</span>
                                </div>
                            </div>
                            <div className="profile__reviews-right-item-content">test</div>
                        </div>
                    </div>
                    <div className="profile__reviews-right-item">
                        <div className="profile__reviews-right-picture">
