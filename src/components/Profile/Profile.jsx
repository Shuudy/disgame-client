    ...
    return (
        <div className="profile__container">
            <div className="profile__header">
                ...
                <div className="profile__header-infos">
                    ...
                    <div className="profile__header-infos-bio">
                        Joueur passionné avec un amour pour les FPS compétitifs et les jeux de stratégie. Toujours à la recherche de nouveaux coéquipiers !
                    </div>
            ...
            <div className="profile__tabs">
                <div className="profile__tabs-item active">Aperçu</div>
                <div className="profile__tabs-item">Jeux</div>
                <div className="profile__tabs-item">Parties</div>
            </div>
